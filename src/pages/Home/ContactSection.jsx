...
export default function ContactSection() {
  const GOOGLE_SCRIPT_URL="https://script.google.com/macros/s/AKfycbxmWYyGNbgIo9lRkWepWqwVTfAvBT6exyUA6NwTCFM0ptQSgsa_igpfuVyLW3btXEK17w/exec"
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-xl text-white mb-8">
            Ready to source premium spices? Our export specialists are here to help with samples, pricing, and custom requirements.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded ${errors.company ? "border-red-600" : "border-black"}`}
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded ${errors.contactPerson ? "border-red-600" : "border-black"}`}
                  required
                />
                {errors.contactPerson && <p className="text-red-600 mt-1 text-sm">{errors.contactPerson}</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded ${errors.email ? "border-red-600" : "border-black"}`}
                  required
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded ${errors.phone ? "border-red-600" : "border-black"}`}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border p-2 rounded ${errors.quantity ? "border-red-600" : "border-black"}`}
                />
